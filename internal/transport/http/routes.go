...
func RegisterRoutes(app *fiber.App, h *handlers.Container, jwtManager *authjwt.Manager) {
	...
	api.Post("/opportunities/:id/analytics", middleware.RequireJWT(jwtManager), h.Public.AnalyzeOpportunity)
	api.Get("/me/networking", middleware.RequireJWT(jwtManager), h.Public.GetNetworking)
	api.Get("/me/recommendation-opportunities", middleware.RequireJWT(jwtManager), h.Public.ListRecommendationOpportunities)
	...
	api.Get("/students/:id/resumes", h.Public.ListStudentResumes)
	api.Get("/students/:id/resumes/:resumeId", h.Public.GetStudentResume)
	...
	student.Get("/resumes/:id/work-experiences", h.Student.ListResumeWorkExperiences)
	student.Post("/resumes/:id/work-experiences", h.Student.CreateResumeWorkExperience)
	student.Patch("/resumes/:id/work-experiences/:experienceId", h.Student.UpdateResumeWorkExperience)
	student.Delete("/resumes/:id/work-experiences/:experienceId", h.Student.DeleteResumeWorkExperience)
	...
	student.Patch("/notifications/read", h.Student.MarkAllNotificationsRead)
	student.Patch("/notifications/:id/read", h.Student.MarkNotificationRead)
	...
	employer.Post("/opportunities/:id/analytics", h.Employer.AnalyzeOpportunity)
