    ...
    "paths": {
        "/api/auth/curator/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для входа куратора",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/curator/company-verifications": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/curator/company-verifications/{id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/curator/employer-profiles/{id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID пользователя-работодателя",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EmployerProfileInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/curator/moderation-queue/{id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID элемента очереди модерации",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/curator/opportunities/{id}/status": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/curator/student-profiles/{id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.StudentProfileInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/curator/users": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные куратора",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CuratorCreateInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CompanyInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/employer/company-links": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные ссылки компании",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CompanyLinkInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/employer/company-verifications": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.VerificationInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/employer/opportunities": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные возможности",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.OpportunityInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/employer/opportunities/{id}/analytics": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/employer/opportunities/{id}/applications": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.ChatConversationListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ChatConversationInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.ChatConversationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/me/contact-requests": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные запроса в контакты",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ContactRequestInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/me/contact-requests/{id}": {
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID запроса в контакты",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/me/favorite-companies/{companyId}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/me/favorite-opportunities/{opportunityId}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.NetworkingOverviewResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/me/portfolio-projects": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные проекта портфолио",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.PortfolioProjectInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/me/recommendation-opportunities": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/me/recommendations": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные рекомендации",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RecommendationInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ResumeInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/me/resumes/{id}/work-experiences": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ResumeWorkExperienceInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/me/resumes/{id}/work-experiences/{experienceId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/opportunities": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Фильтр по типу возможности",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/api/opportunities/{id}/analytics": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ApplicationInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/students": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Поиск по имени, университету, факультету, специализации",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Фильтр по университету",
        ...
        "/api/students/{id}/resumes/{resumeId}": {
            "get": {
                "produces": [
                    "application/json"
                ],
    ...
    "definitions": {
        ...
        "dto.RegisterInput": {
            ...
            "properties": {
                ...
                "email": {
                    "type": "string",
                    "example": "student@tramplin.local"
                },
                "password": {
                    "type": "string",
                    "example": "secret123"
        ...
        "handlers.ChatConversationListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.ChatConversation"
                    }
                },
                "status": {
                    "type": "string",
        ...
        "handlers.ChatConversationResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.ChatConversation"
        ...
        "handlers.NetworkingOverviewResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.NetworkingOverview"
                },
                "status": {
                    "type": "string",
                    "example": "ok"
        ...
        "models.NetworkingOverview": {
            ...
            "properties": {
                ...
                "suggested_people": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.NetworkingSuggestion"
                    }
                },
                "user_id": {
                    "type": "string"
        ...
        "models.NetworkingSuggestion": {
            "type": "object",
            "properties": {
                "mutual_contacts_count": {
                    "type": "integer"
                },
                "reason": {
                    "type": "string"
